...
nx g hasura-feature event-join --subfolder events --folder new-features
nx g hasura-feature form --folder new-features
nx g hasura-feature individual --folder new-features
nx g hasura-feature user-info --subfolder individuals --folder new-features
nx g hasura-feature bot-info --subfolder individuals --folder new-features
nx g hasura-feature project --folder new-features
nx g hasura-feature team --folder new-features
nx g hasura-feature action --subfolder teams --folder new-features
