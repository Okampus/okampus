...
export type DocumentUploadModel = FileUploadModel & {
  ...
  tenant?: Maybe<TenantCoreModel>;
  updatedAt: Scalars['DateTime'];
  uploadedBy?: Maybe<IndividualModel>;
  url: Scalars['String'];
};
...
export type DocumentInfoFragment = { __typename: 'DocumentModel', id: string, createdAt: any, name: string, yearVersion?: number | null, documentUpload: (
    { __typename?: 'DocumentUploadModel' }
