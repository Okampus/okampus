...
export class ShortcutsService extends RequestContext {
  ...
  checkPermsCreate(props: ShortcutInsertInput) {
  ...
  checkPermsDelete(shortcut: Shortcut) {
  ...
  checkPermsUpdate(props: ShortcutSetInput, shortcut: Shortcut) {
  ...
  checkPropsConstraints(props: ShortcutSetInput) {
  ...
  checkCreateRelationships(props: ShortcutInsertInput) {
    // Custom logic
  ...
  async updateShortcutMany(selectionSet: string[], updates: Array<ShortcutUpdates>) {
    ...
    for (const update of updates) {
      ...
      const canUpdate = this.checkPermsUpdate(update._set, shortcut);
  ...
  async updateShortcutByPk(selectionSet: string[], pkColumns: ShortcutPkColumnsInput, _set: ShortcutSetInput) {
    ...
    const canUpdate = this.checkPermsUpdate(_set, shortcut);
  ...
  async deleteShortcut(selectionSet: string[], where: ShortcutBoolExp) {
    ...
    for (const shortcut of shortcuts) {
      const canDelete = this.checkPermsDelete(shortcut);
