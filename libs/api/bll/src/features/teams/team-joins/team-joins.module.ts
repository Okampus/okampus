...
import { TeamJoinsQueryAggregateResolver, TeamJoinsQueryResolver } from './team-joins.resolver';
...
@Module({
  ...
  providers: [TeamJoinsQueryResolver, TeamJoinsQueryAggregateResolver, TeamJoinsService],
