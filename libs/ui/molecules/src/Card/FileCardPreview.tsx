...
import { getFileTypeIcon, ImageGradient } from '@okampus/ui/atoms';
...
export function FileCardPreview({ file, isImage, previewImageSrc, onRemove, onClick }: FileCardPreviewProps) {
