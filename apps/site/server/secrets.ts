...
export const sessionSecret = Buffer.from(process.env.SESSION_SECRET || 'session_secret');
...
export const goCardLessSecretId = process.env.GOCARDLESS_SECRET_ID;
export const goCardLessSecretKey = process.env.GOCARDLESS_SECRET_KEY;
export const googleCustomSearchApiKey = process.env.GOOGLE_CUSTOM_SEARCH_API_KEY;
export const inseeApiKey = process.env.INSEE_API_KEY;
