...
export default forwardRef<HTMLInputElement, RadioInputProps>(function RadioInput(props, ref) {
  ...
  const labelClassName = clsx(
    'outline outline-2 outline-[var(--border-1)] peer-checked:outline-[var(--info)] flex gap-3 py-3 px-3.5 bg-[var(--bg-main)] rounded-lg cursor-pointer hover:bg-[var(--bg-1)]',
