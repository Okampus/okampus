...
export type SigninPageProps = { params: { lang: LocalePath; domain: string } };
...
export default async function TenantSigninPage({ params: { lang, domain } }: SigninPageProps) {
  ...
  if (!tenantNameByDomain) return notFound();
        ...
        <div className="flex flex-col items-center py-12 overflow-y-auto scrollbar w-full">
          <div className="max-w-[30rem] w-full px-12">
            <div className="text-0 flex flex-col items-start gap-8 mb-12">
              ...
              <h1 className="text-2xl text-left font-semibold text-0">
                {t('common', 'welcome')} sur le portail de {tenantNameByDomain.actor.name} 👋
              </h1>
            </div>
