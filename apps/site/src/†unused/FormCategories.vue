        ...
        <section class="flex flex-col gap-4">
            ...
            <div>
                ...
                <div v-if="v$.model[0].typePaiement.$error" class="flex flex-col">
                    <AlertInline v-for="(error, i) in v$.model[0].typePaiement.$errors" :key="i" type="error">
                        <template #message>
                            <div class="subtitle">
                                {{ error.$message }}
                            </div>
            ...
            <div class="grid grid-cols-2 gap-12">
                <div>
                    ...
                    <div v-if="v$.model[0].montant.$error" class="flex flex-col">
                        <AlertInline v-for="(error, i) in v$.model[0].montant.$errors" :key="i" type="error">
                            <template #message>
                                <div class="subtitle">
                                    {{ error.$message }}
                                </div>
            ...
            <div>
                ...
                <div v-if="v$.model[0].date.$error" class="flex flex-col">
                    <AlertInline v-for="(error, i) in v$.model[0].date.$errors" :key="i" type="error">
                        <template #message>
                            <div class="subtitle">
                                {{ error.$message }}
                            </div>
            ...
            <div>
                ...
                <div v-if="v$.model[0].files.$error" class="flex flex-col">
                    <AlertInline v-for="(error, i) in v$.model[0].files.$errors" :key="i" type="error">
                        <template #message>
                            <div class="subtitle">
                                {{ error.$message }}
                            </div>
