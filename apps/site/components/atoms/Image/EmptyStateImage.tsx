...
export default function EmptyStateImage({ image, title, subtitle, cta, className = 'm-8' }: EmptyStateImageProps) {
  return (
    <div className="w-full flex justify-center items-center">
      <div className={clsx('w-full flex flex-col justify-center max-w-[40rem]', className)}>
        {image}
        {title && <h2 className="text-0 text-2xl font-semibold text-center mt-6">{title}</h2>}
