...
import type { Validation } from '../../../validations/entities/validation.entity';
...
export abstract class ContentMaster extends BaseEntity {
  ...
  @OneToMany('Validation', 'contentMaster', { cascade: [Cascade.ALL] })
  @TransformCollection()
  validations = new Collection<Validation>(this);

  @OneToMany('Reaction', 'contentMaster', { cascade: [Cascade.ALL] })
  @TransformCollection()
  reactions = new Collection<Reaction>(this);

  @OneToMany('Report', 'contentMaster', { cascade: [Cascade.ALL] })
  @TransformCollection()
  reports = new Collection<Report>(this);

  @OneToMany('Vote', 'contentMaster', { cascade: [Cascade.ALL] })
  @TransformCollection()
  votes = new Collection<Vote>(this);

  @OneToMany('Favorite', 'contentMaster', { cascade: [Cascade.ALL] })
  @TransformCollection()
