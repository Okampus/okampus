...
import type { CreateTeamGalleryDto } from '@upload/team-galleries/dto/create-team-gallery.dto';
...
export class TeamGalleriesService {
  ...
  public async findAll(options: TeamGalleryListOptions): Promise<PaginatedNodes<TeamGallery>> {
