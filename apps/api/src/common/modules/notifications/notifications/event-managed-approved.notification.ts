...
export class EventManagedApprovedNotification extends Notification {
  public readonly type = NotificationType.EventManagedApproved;
  public readonly settingName = 'notificationEventManagedApproved';
