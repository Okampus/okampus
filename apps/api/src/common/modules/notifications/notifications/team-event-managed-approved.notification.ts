...
export class TeamEventManagedApprovedNotification extends Notification {
  public readonly type = NotificationType.TeamEventManagedApproved;
  public readonly settingName = 'notificationTeamEventManagedApproved';
