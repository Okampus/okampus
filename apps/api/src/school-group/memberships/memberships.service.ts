...
// import type { UpdateSchoolGroupDto } from './dto/update-team-member.dto';
...
export class SchoolGroupMembershipsService {
  constructor(
    ...
    public async updateMembership(
      ...
      const schoolYear = (typeof updateSchoolGroupMembershipDto.schoolYearId === 'number') ? await this.schoolYearRepository
      .findOneOrFail({ id: updateSchoolGroupMembershipDto.schoolYearId }) : null;
