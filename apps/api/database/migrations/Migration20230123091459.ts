...
export class Migration20230123091459 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "team_category" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "name" text not null, "description" text null);');

    this.addSql('create table "tag" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "name" text not null, "color" text check ("color" in (\'Amber\', \'Blue\', \'Cyan\', \'Emerald\', \'Fuchsia\', \'Gray\', \'Green\', \'Indigo\', \'Lime\', \'Neutral\', \'Orange\', \'Pink\', \'Purple\', \'Red\', \'Rose\', \'Sky\', \'Slate\', \'Stone\', \'Teal\', \'Violet\', \'Yellow\', \'Zinc\')) not null, "description" text null);');
    ...
    this.addSql('create table "shortcut" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "name" varchar(255) not null, "subroute" varchar(255) not null, "resource_id" varchar(255) not null, "user_id" bigint not null);');
    ...
    this.addSql('create table "file_upload" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "file_upload_kind" text check ("file_upload_kind" in (\'Image\', \'Document\', \'Video\')) not null, "uploaded_by_id" bigint not null, "url" text not null, "name" text not null, "size" int not null, "mime" text not null, "last_modified_at" timestamptz(0) not null, "number_of_pages" smallint null, "number_of_words" int null, "document_type" text check ("document_type" in (\'Slideshow\', \'CSVLike\', \'Spreadsheet\', \'Code\', \'Markdown\', \'Text\', \'Document\')) null, "duration" int null, "width" smallint null, "height" smallint null);');
    ...
    this.addSql('create table "ugc" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "ugc_kind" text check ("ugc_kind" in (\'Content\', \'Document\', \'Form\', \'FormSubmission\')) not null, "author_id" bigint not null, "real_author_id" bigint not null, "is_anonymous" boolean not null, "org_id" bigint null, "content_master_id" bigint null, "upvote_count" int not null, "downvote_count" int not null, "total_vote_count" int not null, "report_count" int not null, "favorite_count" int not null, "comment_count" int not null, "text" text null, "parent_id" bigint null, "document_kind" text check ("document_kind" in (\'InfoDocument\', \'StudyDocument\', \'Document\')) null, "document_id" bigint null, "year_version" smallint null, "name" text null, "description" text null, "schema" jsonb null, "type" text check ("type" in (\'EventRegistration\', \'MembershipRequest\', \'Internal\', \'Survey\')) null, "is_template" boolean null, "submission" jsonb null, "for_form_id" bigint null);');
    this.addSql('create index "ugc_ugc_kind_index" on "ugc" ("ugc_kind");');
    this.addSql('alter table "ugc" add constraint "ugc_document_id_unique" unique ("document_id");');
    ...
    this.addSql('create table "org" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "org_kind" text check ("org_kind" in (\'Canteen\', \'ClassGroup\', \'Cohort\', \'Team\', \'Tenant\')) not null, "actor_id" bigint not null, "parent_id" bigint null, "description" text null, "year" smallint null, "logo_id" bigint null, "tagline" text null, "type" text check ("type" in (\'Team\', \'Club\', \'Project\')) null, "video_id" bigint null, "membership_fees" int null, "member_count" int null, "join_form_id" bigint null, "directors_category_name" text null, "managers_category_name" text null, "members_category_name" text null, "n_approval_steps" int null, "event_approval_form" jsonb null);');
    ...
    this.addSql('create table "role" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "role_kind" text check ("role_kind" in (\'TeamRole\', \'CanteenRole\', \'CohortRole\', \'TenantRole\')) not null, "name" text not null, "color" text check ("color" in (\'Amber\', \'Blue\', \'Cyan\', \'Emerald\', \'Fuchsia\', \'Gray\', \'Green\', \'Indigo\', \'Lime\', \'Neutral\', \'Orange\', \'Pink\', \'Purple\', \'Red\', \'Rose\', \'Sky\', \'Slate\', \'Stone\', \'Teal\', \'Violet\', \'Yellow\', \'Zinc\')) not null, "required" boolean not null, "canteen_id" bigint null, "team_id" bigint null, "permissions" text[] null, "category" text check ("category" in (\'Directors\', \'Managers\', \'Members\')) null);');
    this.addSql('create index "role_role_kind_index" on "role" ("role_kind");');

    this.addSql('create table "org_document" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "org_id" bigint not null, "document_id" bigint not null, "type" text check ("type" in (\'Constitution\', \'Documentation\', \'Rules\', \'Transcript\', \'LegalReceipt\', \'Brochure\', \'GraphicCharter\')) not null);');

    this.addSql('create table "org_files" ("org_id" bigint not null, "file_upload_id" bigint not null, constraint "org_files_pkey" primary key ("org_id", "file_upload_id"));');

    this.addSql('create table "org_categories" ("org_id" bigint not null, "team_category_id" bigint not null, constraint "org_categories_pkey" primary key ("org_id", "team_category_id"));');
    ...
    this.addSql('create table "membership_role" ("membership_id" bigint not null, "role_id" bigint not null, constraint "membership_role_pkey" primary key ("membership_id", "role_id"));');

    this.addSql('create table "membership_canteen_role" ("membership_id" bigint not null, "role_id" bigint not null, constraint "membership_canteen_role_pkey" primary key ("membership_id", "role_id"));');

    this.addSql('create table "event_approval_step" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "tenant_org_id" bigint not null, "created_by_id" bigint not null, "order" int not null, "name" varchar(255) not null);');
    ...
    this.addSql('create table "project" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "team_id" bigint not null, "team_member_id" bigint not null, "name" text not null, "description" text null, "linked_event_id" bigint null, "expected_budget" int not null, "actual_budget" int null, "created_by_id" bigint not null, "supervisor_id" bigint not null);');
    ...
    this.addSql('create table "finance" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "transaction" text not null, "description" text null, "payment_date" timestamptz(0) not null, "address_name" text not null, "address_latitude" real null, "address_longitude" real null, "address_street" text null, "address_city" text null, "address_zip" int null, "address_state" text null, "address_country" text null, "amount_due" real not null, "amount_payed" real not null, "payment_method" text check ("payment_method" in (\'Cash\', \'CreditCard\', \'Transfer\', \'RegularTransfer\', \'Check\', \'MobilePayment\', \'Other\')) not null, "state" text check ("state" in (\'Canceled\', \'Ongoing\', \'Completed\')) not null, "category" text check ("category" in (\'Entertainment\', \'Equipement\', \'Errands\', \'Fees\', \'Insurance\', \'Logistics\', \'Marketing\', \'Provider\', \'Subscriptions\', \'Transportation\', \'Other\')) not null, "team_id" bigint not null, "added_by_id" bigint not null, "linked_event_id" bigint null, "linked_project_id" bigint null);');

    this.addSql('create table "finance_linked_documents" ("finance_id" bigint not null, "file_upload_id" bigint not null, constraint "finance_linked_documents_pkey" primary key ("finance_id", "file_upload_id"));');
    ...
    this.addSql('alter table "team_category" add constraint "team_category_tenant_id_foreign" foreign key ("tenant_id") references "tenant_core" ("id") on update cascade;');
    ...
    this.addSql('alter table "document_edit" add constraint "document_edit_added_document_id_foreign" foreign key ("added_document_id") references "file_upload" ("id") on update cascade;');
    ...
    this.addSql('alter table "ugc" add constraint "ugc_org_id_foreign" foreign key ("org_id") references "org" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "ugc" add constraint "ugc_document_id_foreign" foreign key ("document_id") references "file_upload" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "org_document" add constraint "org_document_document_id_foreign" foreign key ("document_id") references "file_upload" ("id") on update cascade;');

    this.addSql('alter table "org_files" add constraint "org_files_org_id_foreign" foreign key ("org_id") references "org" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "org_files" add constraint "org_files_file_upload_id_foreign" foreign key ("file_upload_id") references "file_upload" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "org_categories" add constraint "org_categories_team_category_id_foreign" foreign key ("team_category_id") references "team_category" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "membership_role" add constraint "membership_role_membership_id_foreign" foreign key ("membership_id") references "membership" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "membership_role" add constraint "membership_role_role_id_foreign" foreign key ("role_id") references "role" ("id") on update cascade on delete cascade;');

    this.addSql('alter table "membership_canteen_role" add constraint "membership_canteen_role_membership_id_foreign" foreign key ("membership_id") references "membership" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "membership_canteen_role" add constraint "membership_canteen_role_role_id_foreign" foreign key ("role_id") references "role" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "event_approval_step" add constraint "event_approval_step_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade;');
    ...
    this.addSql('alter table "project" add constraint "project_team_member_id_foreign" foreign key ("team_member_id") references "membership" ("id") on update cascade;');
    ...
    this.addSql('alter table "finance" add constraint "finance_added_by_id_foreign" foreign key ("added_by_id") references "membership" ("id") on update cascade;');
    ...
    this.addSql('alter table "finance_linked_documents" add constraint "finance_linked_documents_finance_id_foreign" foreign key ("finance_id") references "finance" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "finance_linked_documents" add constraint "finance_linked_documents_file_upload_id_foreign" foreign key ("file_upload_id") references "file_upload" ("id") on update cascade on delete cascade;');
  ...
  async down(): Promise<void> {
    this.addSql('alter table "team_category" drop constraint "team_category_tenant_id_foreign";');
    ...
    this.addSql('alter table "org_categories" drop constraint "org_categories_team_category_id_foreign";');
    ...
    this.addSql('alter table "document_edit" drop constraint "document_edit_added_document_id_foreign";');

    this.addSql('alter table "content_master" drop constraint "content_master_image_id_foreign";');

    this.addSql('alter table "ugc" drop constraint "ugc_document_id_foreign";');
    ...
    this.addSql('alter table "org_files" drop constraint "org_files_file_upload_id_foreign";');

    this.addSql('alter table "finance_linked_documents" drop constraint "finance_linked_documents_file_upload_id_foreign";');
    ...
    this.addSql('alter table "ugc" drop constraint "ugc_org_id_foreign";');
    ...
    this.addSql('alter table "org_files" drop constraint "org_files_org_id_foreign";');
    ...
    this.addSql('alter table "membership_role" drop constraint "membership_role_role_id_foreign";');

    this.addSql('alter table "membership_canteen_role" drop constraint "membership_canteen_role_role_id_foreign";');
    ...
    this.addSql('alter table "membership_role" drop constraint "membership_role_membership_id_foreign";');

    this.addSql('alter table "membership_canteen_role" drop constraint "membership_canteen_role_membership_id_foreign";');

    this.addSql('alter table "project" drop constraint "project_team_member_id_foreign";');

    this.addSql('alter table "team_action" drop constraint "team_action_team_member_id_foreign";');

    this.addSql('alter table "finance" drop constraint "finance_added_by_id_foreign";');
    ...
    this.addSql('alter table "finance_linked_documents" drop constraint "finance_linked_documents_finance_id_foreign";');

    this.addSql('drop table if exists "tenant_core" cascade;');

    this.addSql('drop table if exists "team_category" cascade;');
    ...
    this.addSql('drop table if exists "org_files" cascade;');

    this.addSql('drop table if exists "org_categories" cascade;');

    this.addSql('drop table if exists "membership" cascade;');

    this.addSql('drop table if exists "membership_role" cascade;');

    this.addSql('drop table if exists "membership_canteen_role" cascade;');
    ...
    this.addSql('drop table if exists "finance_linked_documents" cascade;');
