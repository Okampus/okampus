...
export class Migration20230620071900 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "event_supervisors" ("event_id" bigint not null, "user_info_id" bigint not null, constraint "event_supervisors_pkey" primary key ("event_id", "user_info_id"));');
    ...
    this.addSql('alter table "mission_join" add constraint "mission_join_joiner_id_foreign" foreign key ("joiner_id") references "user_info" ("id") on update cascade;');
    ...
    this.addSql('alter table "event_supervisors" add constraint "event_supervisors_user_info_id_foreign" foreign key ("user_info_id") references "user_info" ("id") on update cascade on delete cascade;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "event_supervisors" drop constraint "event_supervisors_user_info_id_foreign";');
