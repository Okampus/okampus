...
export class Migration20230624152835 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "mission_join" add constraint "mission_join_points_settled_by_id_foreign" foreign key ("points_settled_by_id") references "individual" ("id") on update cascade on delete set null;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "mission_join" drop constraint "mission_join_points_settled_by_id_foreign";');
