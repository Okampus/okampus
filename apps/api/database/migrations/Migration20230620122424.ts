...
export class Migration20230620122424 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "legal_unit" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "order" smallint not null, "type" text check ("type" in (\'Company\', \'Association\', \'TenantGrantFund\')) not null, "pseudo" text not null, "url" text not null, constraint "legal_unit_pkey" primary key ("id"));');

    this.addSql('create table "form" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "name" text not null, "team_id" bigint null, "schema" jsonb not null, "type" text check ("type" in (\'Event\', \'Team\', \'Internal\', \'Survey\')) not null, "is_enabled" boolean not null, "is_allowing_multiple_answers" boolean not null, "is_allowing_editing_answers" boolean not null, "is_required" boolean not null, constraint "form_pkey" primary key ("id"));');
    this.addSql('alter table "form" add constraint "form_team_id_unique" unique ("team_id");');

    this.addSql('create table "file_upload" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "name" text not null, "size" int not null, "type" text not null, "url" text not null, "file_last_modified_at" timestamptz(0) not null, constraint "file_upload_pkey" primary key ("id"));');
    ...
    this.addSql('create table "content" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "text" text not null, "is_anonymous" boolean not null, "parent_id" bigint null default null, "replying_to_id" bigint null default null, "team_id" bigint not null, constraint "content_pkey" primary key ("id"));');
    ...
    this.addSql('create table "event_manage" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "activities" text not null default \'\', "event_id" bigint not null, "team_id" bigint not null, constraint "event_manage_pkey" primary key ("id"));');

    this.addSql('create table "mission" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "name" text not null, "description" text not null default \'\', "points_minimum" smallint not null, "points_maximum" smallint not null, "quantity" smallint not null default 1, "auto_accept_member" boolean not null default false, "is_template" boolean not null default false, "color" text check ("color" in (\'Blue\', \'DeepBlue\', \'DarkBlue\', \'LightBlue\', \'Green\', \'DeepGreen\', \'DarkGreen\', \'LightGreen\', \'Orange\', \'DeepOrange\', \'DarkOrange\', \'LightOrange\', \'Red\', \'DeepRed\', \'DarkRed\', \'LightRed\', \'Purple\', \'DeepPurple\', \'DarkPurple\', \'LightPurple\', \'Gray\', \'DeepGray\', \'DarkGray\', \'Turquoise\', \'Pink\', \'Cyan\', \'Brown\', \'Indigo\', \'Lime\', \'Teal\')) not null default \'Blue\', "team_id" bigint not null, "event_manage_id" bigint null default null, "project_id" bigint null default null, constraint "mission_pkey" primary key ("id"));');
    ...
    this.addSql('alter table "content" add constraint "content_team_id_foreign" foreign key ("team_id") references "team" ("id") on update cascade;');
