...
export class Migration20230630214437 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "actor" ("id" bigint not null default "public"."snowflake"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "slug" text not null, "name" text not null, "status" text not null default \'\', "bio" text not null default \'\', "email" text not null default \'\', "website" text not null default \'\', "ical" text not null default "public"."id_generator"(21), "individual_id" bigint null default null, "team_id" bigint null default null, "legal_unit_id" bigint null default null, "legal_unit_location_id" bigint null default null, constraint "actor_pkey" primary key ("id"));');
    ...
    this.addSql('create table "location" ("id" bigint not null default "public"."snowflake"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "type" text check ("type" in (\'Address\', \'Campus\', \'Online\')) not null, "name" text not null, "online_link" text not null default \'\', "location_note" text not null default \'\', "actor_id" bigint not null, "address_id" bigint null default null, constraint "location_pkey" primary key ("id"));');
