...
export class Migration20230622090645 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "user" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "first_name" text not null, "middle_names" text[] not null default \'{}\', "last_name" text not null, "customization_color" text check ("customization_color" in (\'Blue\', \'DeepBlue\', \'DarkBlue\', \'LightBlue\', \'Green\', \'DeepGreen\', \'DarkGreen\', \'LightGreen\', \'Orange\', \'DeepOrange\', \'DarkOrange\', \'LightOrange\', \'Red\', \'DeepRed\', \'DarkRed\', \'LightRed\', \'Purple\', \'DeepPurple\', \'DarkPurple\', \'LightPurple\', \'Gray\', \'DeepGray\', \'DarkGray\', \'Turquoise\', \'Pink\', \'Cyan\', \'Brown\', \'Indigo\', \'Lime\', \'Teal\')) null default null, "customization_signature" text null default null, "stats_points" int not null default 0, "stats_post_count" smallint not null default 0, "stats_last_post_at" timestamptz(0) null default null, "stats_post_streak" smallint not null default 0, "stats_reply_count" smallint not null default 0, "stats_last_reply_at" timestamptz(0) null default null, "stats_reply_streak" smallint not null default 0, "stats_comment_count" smallint not null default 0, "stats_last_comment_at" timestamptz(0) null default null, "stats_upload_count" smallint not null default 0, "stats_last_action_at" timestamptz(0) null default null, "stats_action_streak" smallint not null default 0, "settings_is_dark_mode_activated" boolean not null default false, "settings_is_gdpr_exported_on_account_deactivation" boolean not null default true, "settings_is_gdpr_anonymized_on_account_deactivation" boolean not null default false, "notification_settings_mentionned" smallint not null, "notification_settings_badge_unlocked" smallint not null, "notification_settings_blog_subscribed_updated" smallint not null, "notification_settings_content_removed" smallint not null, "notification_settings_admin_report_created" smallint not null, "notification_settings_event_created" smallint not null, "notification_settings_team_subscribed_event_created" smallint not null, "notification_settings_team_managed_form_updated" smallint not null, "notification_settings_team_managed_event_updated" smallint not null, "notification_settings_team_managed_membership_request_updated" smallint not null, "notification_settings_team_managed_member_role_updated" smallint not null, "notification_settings_admin_team_social_updated" smallint not null, "notification_settings_admin_team_legal_file_updated" smallint not null, "notification_settings_event_subscribed_updated" smallint not null, "notification_settings_event_managed_approved" smallint not null, "notification_settings_event_managed_rejected" smallint not null, "notification_settings_event_managed_registration_created" smallint not null, "notification_settings_admin_event_validation_started" smallint not null, "notification_settings_admin_event_validation_step" smallint not null, "notification_settings_admin_event_validation_approved" smallint not null, "notification_settings_admin_event_validation_rejected" smallint not null, "notification_settings_thread_subscribed_updated" smallint not null, "notification_settings_thread_subscribed_answered" smallint not null, "notification_settings_admin_thread_stale" smallint not null, "notification_settings_admin_thread_stale_threshold" int not null default 1209600, "notification_settings_admin_thread_assigned_stale" smallint not null, "notification_settings_admin_thread_assigned_stale_threshold" int not null default 604800, "notification_settings_admin_thread_assigned" smallint not null, "notification_settings_role_updated" smallint not null, "notification_settings_admin_role_updated" smallint not null, "is_introduction_finished" boolean not null default false, "is_onboarding_finished" boolean not null default false, constraint "user_pkey" primary key ("id"));');
    ...
    this.addSql('create table "team" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "type" text check ("type" in (\'Association\', \'Canteen\', \'Company\', \'Club\', \'Project\', \'Department\', \'Tenant\')) not null default \'Club\', "original_creation_day" smallint null default null, "original_creation_month" smallint null default null, "original_creation_year" smallint null default null, "membership_fees" real not null default 0, "current_finance" real not null default 0, "directors_category_name" text not null default \'Directors\', "managers_category_name" text not null default \'Managers\', "members_category_name" text not null default \'Members\', "canteen_id" bigint null default null, "cohort_id" bigint null default null, "class_group_id" bigint null default null, "admin_team_tenant_id" bigint null default null, "tenant_grant_fund_id" bigint null default null, "parent_id" bigint null default null, "video_id" bigint null default null, constraint "team_pkey" primary key ("id"));');
    ...
    this.addSql('alter table "team" add constraint "team_admin_team_tenant_id_unique" unique ("admin_team_tenant_id");');

    this.addSql('create table "tenant" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "domain" text not null, "name" text not null, "point_name" text not null, "oidc_info_is_oidc_enabled" boolean not null default true, "oidc_info_oidc_name" text null default null, "oidc_info_oidc_client_id" text null default null, "oidc_info_oidc_client_secret" text null default null, "oidc_info_oidc_discovery_url" text null default null, "oidc_info_oidc_scopes" text null default null, "oidc_info_oidc_callback_uri" text null default null, "event_validation_form_id" bigint null default null, constraint "tenant_pkey" primary key ("id"));');
    ...
    this.addSql('create table "individual" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "user_id" bigint null default null, "bot_id" bigint null default null, "password_hash" text null default null, "scope_role" text check ("scope_role" in (\'tenant_user\', \'tenant_teacher\', \'tenant_admin\', \'admin\')) not null, constraint "individual_pkey" primary key ("id"));');
    ...
    this.addSql('create table "actor" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "individual_id" bigint null, "team_id" bigint null, "legal_unit_id" bigint null, "slug" text not null, "name" text not null, "status" text not null default \'\', "bio" text not null default \'\', "email" text not null default \'\', "website" text not null default \'\', "ical" text not null, constraint "actor_pkey" primary key ("id"));');
    ...
    this.addSql('create table "event_approval" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "message" text null default null, "is_approved" boolean not null, "event_id" bigint null, "step_id" bigint null, constraint "event_approval_pkey" primary key ("id"));');
    ...
    this.addSql('create table "event_join" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "state" text check ("state" in (\'Approved\', \'Rejected\', \'Canceled\', \'Pending\')) not null default \'Pending\', "presence" boolean null default null, "settled_by_id" bigint null default null, "settled_at" timestamptz(0) null default null, "presence_settled_by_id" bigint null default null, "presence_settled_at" timestamptz(0) null default null, "presence_settled_via" text check ("presence_settled_via" in (\'Bot\', \'QR\', \'Manual\', \'Automatic\')) null, "event_id" bigint not null, "joiner_id" bigint not null, "joined_for_id" bigint null default null, "qr_code_id" bigint null default null, "mission_join_id" bigint null default null, "form_submission_id" bigint null default null, constraint "event_join_pkey" primary key ("id"));');

    this.addSql('create table "mission_join" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "points" smallint null default null, "state" text check ("state" in (\'Approved\', \'Rejected\', \'Canceled\', \'Pending\')) not null default \'Pending\', "completed" boolean null default null, "settled_by_id" bigint null default null, "settled_at" timestamptz(0) null default null, "completed_settled_by_id" bigint null default null, "completed_settled_at" timestamptz(0) null default null, "mission_id" bigint not null, "joiner_id" bigint not null, "event_join_id" bigint null default null, "project_id" bigint null default null, constraint "mission_join_pkey" primary key ("id"));');
    ...
    this.addSql('alter table "team" add constraint "team_admin_team_tenant_id_foreign" foreign key ("admin_team_tenant_id") references "tenant" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "team_join" add constraint "team_join_joiner_id_foreign" foreign key ("joiner_id") references "user" ("id") on update cascade;');
    this.addSql('alter table "team_join" add constraint "team_join_settled_by_id_foreign" foreign key ("settled_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "expense" add constraint "expense_settled_by_id_foreign" foreign key ("settled_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "event_join" add constraint "event_join_settled_by_id_foreign" foreign key ("settled_by_id") references "individual" ("id") on update cascade on delete set null;');
    this.addSql('alter table "event_join" add constraint "event_join_presence_settled_by_id_foreign" foreign key ("presence_settled_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "event_join" add constraint "event_join_joiner_id_foreign" foreign key ("joiner_id") references "user" ("id") on update cascade;');
    ...
    this.addSql('alter table "mission_join" add constraint "mission_join_settled_by_id_foreign" foreign key ("settled_by_id") references "individual" ("id") on update cascade on delete set null;');
    this.addSql('alter table "mission_join" add constraint "mission_join_completed_settled_by_id_foreign" foreign key ("completed_settled_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "mission_join" add constraint "mission_join_joiner_id_foreign" foreign key ("joiner_id") references "user" ("id") on update cascade;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "team" drop constraint "team_admin_team_tenant_id_foreign";');
    ...
    this.addSql('alter table "grant_unlock" drop constraint "grant_unlock_tenant_id_foreign";');
    ...
    this.addSql('alter table "grant" drop constraint "grant_validated_by_id_foreign";');
    ...
    this.addSql('alter table "team_join" drop constraint "team_join_settled_by_id_foreign";');
    ...
    this.addSql('alter table "expense" drop constraint "expense_settled_by_id_foreign";');

    this.addSql('alter table "finance" drop constraint "finance_created_by_id_foreign";');

    this.addSql('alter table "grant_unlock" drop constraint "grant_unlock_created_by_id_foreign";');

    this.addSql('alter table "grant_unlock" drop constraint "grant_unlock_validated_by_id_foreign";');
    ...
    this.addSql('alter table "event_join" drop constraint "event_join_settled_by_id_foreign";');

    this.addSql('alter table "event_join" drop constraint "event_join_presence_settled_by_id_foreign";');

    this.addSql('alter table "mission_join" drop constraint "mission_join_created_by_id_foreign";');

    this.addSql('alter table "mission_join" drop constraint "mission_join_settled_by_id_foreign";');

    this.addSql('alter table "mission_join" drop constraint "mission_join_completed_settled_by_id_foreign";');
    ...
    this.addSql('alter table "grant_unlock" drop constraint "grant_unlock_signature_id_foreign";');

    this.addSql('alter table "grant_unlock" drop constraint "grant_unlock_generated_document_id_foreign";');

    this.addSql('alter table "grant_unlock_attachments" drop constraint "grant_unlock_attachments_file_upload_id_foreign";');
    ...
    this.addSql('alter table "grant_unlock" drop constraint "grant_unlock_finance_id_foreign";');
