...
export class Migration20230703004238 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "individual" ("id" bigint not null default "public"."snowflake"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "password_hash" text null default null, "content_signature" text not null default \'\', "user_id" bigint null default null, "bot_id" bigint null default null, constraint "individual_pkey" primary key ("id"));');
