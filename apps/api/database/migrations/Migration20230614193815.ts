...
export class Migration20230614193815 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "actor" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "individual_id" bigint null, "team_id" bigint null, "slug" text not null, "name" text not null, "status" text not null default \'\', "bio" text not null default \'\', "primary_email" text null default null, "ical" text not null, constraint "actor_pkey" primary key ("id"));');
