...
export class Migration20230203030510 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "ugc" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "ugc_kind" text check ("ugc_kind" in (\'Content\', \'TenantDocument\', \'Form\', \'FormSubmission\')) not null, "author_id" bigint not null, "real_author_id" bigint not null, "is_anonymous" boolean not null, "representing_org_id" bigint null, "content_master_id" bigint null, "upvote_count" int not null, "downvote_count" int not null, "total_vote_count" int not null, "report_count" int not null, "favorite_count" int not null, "comment_count" int not null, "text" text null, "parent_id" bigint null, "document_kind" text check ("document_kind" in (\'InfoDocument\', \'StudyDocument\', \'Document\')) null, "document_upload_id" bigint null, "year_version" smallint null, "name" text null, "description" text null, "schema" jsonb null, "type" text check ("type" in (\'EventRegistration\', \'MembershipRequest\', \'Internal\', \'Survey\')) null, "is_template" boolean null, "submission" jsonb null, "for_form_id" bigint null);');
    ...
    this.addSql('create table "org" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "last_hidden_at" timestamptz(0) null, "org_kind" text check ("org_kind" in (\'Canteen\', \'ClassGroup\', \'Cohort\', \'Team\', \'Tenant\')) not null, "actor_id" bigint not null, "parent_id" bigint null, "description" text null, "year" smallint null, "logo_id" bigint null, "tagline" text null, "type" text check ("type" in (\'Association\', \'Club\', \'Project\', \'Department\')) null, "video_id" bigint null, "membership_fees" int null, "current_finance" int null, "member_count" int null, "join_form_id" bigint null, "directors_category_name" text null, "managers_category_name" text null, "members_category_name" text null, "event_validation_form_id" bigint null);');
