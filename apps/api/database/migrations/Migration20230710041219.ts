...
export class Migration20230710041219 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "event_manage" add constraint "event_manage_project_id_foreign" foreign key ("project_id") references "project" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "tenant_manage" add constraint "tenant_manage_campus_cluster_id_foreign" foreign key ("campus_cluster_id") references "campus_cluster" ("id") on update cascade;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "event_manage" drop constraint "event_manage_project_id_foreign";');
