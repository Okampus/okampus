...
export class Migration20230619142552 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "finance" add constraint "finance_address_id_foreign" foreign key ("address_id") references "actor_address" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "expense_item" add constraint "expense_item_address_id_foreign" foreign key ("address_id") references "actor_address" ("id") on update cascade on delete set null;');
