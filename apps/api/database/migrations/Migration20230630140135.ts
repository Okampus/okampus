...
export class Migration20230630140135 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "individual" ("id" bigint not null default "public"."id_generator"(), "created_at" timestamptz(0) not null default current_timestamp, "created_by_id" bigint null default null, "deleted_at" timestamptz(0) null default null, "tenant_id" bigint not null, "hidden_at" timestamptz(0) null default null, "scope_role" text check ("scope_role" in (\'tenant_user\', \'tenant_teacher\', \'tenant_admin\', \'admin\')) not null, "password_hash" text null default null, "content_signature" text not null default \'\', "user_id" bigint null default null, "bot_id" bigint null default null, constraint "individual_pkey" primary key ("id"));');
    ...
    this.addSql('alter table "grant_allocate" add constraint "grant_allocate_validated_by_id_foreign" foreign key ("validated_by_id") references "individual" ("id") on update cascade on delete set null;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "grant_allocate" drop constraint "grant_allocate_validated_by_id_foreign";');
