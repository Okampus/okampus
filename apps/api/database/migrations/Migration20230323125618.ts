...
export class Migration20230323125618 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "actor" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "slug" text not null, "name" text not null, "bio" text not null, "primary_email" text null, "ical" text not null);');
    this.addSql('alter table "actor" add constraint "actor_ical_unique" unique ("ical");');

    this.addSql('create table "individual" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "individual_kind" text check ("individual_kind" in (\'Bot\', \'User\')) not null, "actor_id" bigint not null, "status" text not null, "token_hash" text null, "owner_id" bigint null, "bot_role" text check ("bot_role" in (\'Official\', \'Admin\', \'Moderator\', \'User\', \'Team\')) null, "first_name" text null, "middle_names" text[] null, "last_name" text null, "password_hash" text null, "roles" text[] null default \'{User}\', "scope_role" text check ("scope_role" in (\'Student\', \'Teacher\', \'Admin\')) null, "customization_color" text check ("customization_color" in (\'Blue\', \'DeepBlue\', \'DarkBlue\', \'LightBlue\', \'Green\', \'DeepGreen\', \'DarkGreen\', \'LightGreen\', \'Orange\', \'DeepOrange\', \'DarkOrange\', \'LightOrange\', \'Red\', \'DeepRed\', \'DarkRed\', \'LightRed\', \'Purple\', \'DeepPurple\', \'DarkPurple\', \'LightPurple\', \'Gray\', \'DeepGray\', \'DarkGray\', \'Turquoise\', \'Pink\', \'Cyan\', \'Brown\', \'Indigo\', \'Lime\', \'Teal\', \'Black\')) null, "customization_signature" text null, "stats_points" int null, "stats_post_count" smallint null, "stats_last_post_at" timestamptz(0) null, "stats_post_streak" smallint null, "stats_reply_count" smallint null, "stats_last_reply_at" timestamptz(0) null, "stats_reply_streak" smallint null, "stats_comment_count" smallint null, "stats_last_comment" timestamptz(0) null, "stats_upload_count" smallint null, "stats_last_action_at" timestamptz(0) null, "stats_action_streak" smallint null, "settings_dark_mode_activated" boolean null, "settings_gdpr_end_of_life_export" boolean null, "settings_gdpr_end_of_life_anonymize" boolean null, "notification_settings_notification_mentionned" smallint null, "notification_settings_notification_badge_unlocked" smallint null, "notification_settings_notification_blog_subscribed_updated" smallint null, "notification_settings_notification_content_removed" smallint null, "notification_settings_notification_admin_report_created" smallint null, "notification_settings_notification_event_created" smallint null, "notification_settings_notification_team_subscribed_event_created" smallint null, "notification_settings_notification_team_managed_form_updated" smallint null, "notification_settings_notification_team_managed_event_updated" smallint null, "notification_settings_notification_team_managed_membership_request_updated" smallint null, "notification_settings_notification_team_managed_member_role_updated" smallint null, "notification_settings_notification_admin_team_social_updated" smallint null, "notification_settings_notification_admin_team_legal_file_updated" smallint null, "notification_settings_notification_event_subscribed_updated" smallint null, "notification_settings_notification_event_managed_approved" smallint null, "notification_settings_notification_event_managed_rejected" smallint null, "notification_settings_notification_event_managed_registration_created" smallint null, "notification_settings_notification_admin_event_validation_started" smallint null, "notification_settings_notification_admin_event_validation_step" smallint null, "notification_settings_notification_admin_event_validation_approved" smallint null, "notification_settings_notification_admin_event_validation_rejected" smallint null, "notification_settings_notification_thread_subscribed_updated" smallint null, "notification_settings_notification_thread_subscribed_answered" smallint null, "notification_settings_notification_admin_thread_stale" smallint null, "notification_settings_notification_admin_thread_stale_threshold" int null, "notification_settings_notification_admin_thread_assigned_stale" smallint null, "notification_settings_notification_admin_thread_assigned_stale_threshold" int null, "notification_settings_notification_admin_thread_assigned" smallint null, "notification_settings_notification_role_updated" smallint null, "notification_settings_notification_admin_role_updated" smallint null, "finished_introduction" boolean null, "finished_onboarding" boolean null);');
    ...
    this.addSql('create table "subject" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "name" text not null, "english_name" text null, "code" text not null, "description" text null, "type" text check ("type" in (\'Mathematics\', \'Physics\', \'English\', \'Communication\', \'Programming\')) not null, "last_active_date" timestamptz(0) null);');
    this.addSql('create index "subject_code_index" on "subject" ("code");');

    this.addSql('create table "social" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "actor_id" bigint not null, "type" text check ("type" in (\'Discord\', \'Instagram\', \'YouTube\', \'TikTok\', \'Twitch\', \'LinkedIn\')) not null, "url" text not null, "pseudo" text not null);');

    this.addSql('create table "shortcut" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "type" text check ("type" in (\'Team\', \'Project\', \'User\', \'Event\')) not null, "user_id" bigint not null, "target_actor_id" bigint not null);');

    this.addSql('create table "session" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "ip" varchar(255) not null, "country" varchar(255) not null, "client_type" text check ("client_type" in (\'WebClient\', \'MobileClient\', \'DesktopClient\')) not null, "user_agent" jsonb not null, "refresh_token_hash" varchar(255) not null, "token_family" varchar(255) not null, "user_id" bigint not null, "last_activity_at" timestamptz(0) not null, "last_issued_at" timestamptz(0) not null, "revoked_at" timestamptz(0) null, "expired_at" timestamptz(0) null);');

    this.addSql('create table "org_metric" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "value" text not null, "type" text check ("type" in (\'MemberInOrgAndChildrenCount\', \'MemberInOrgAndChildrenUniqueCount\', \'MemberInOrgAndChildrenUniqueCount\', \'EventOccuringCount\', \'EventCreatedCount\', \'EventOccuringCount\', \'EventCreatedCount\', \'ProjectCreatedCount\', \'ProjectCreatedCount\', \'ProjectCreatedCount\', \'ProjectCreatedCount\', \'ContentCreatedCount\', \'ContentCreatedCount\', \'ChildOrgCount\')) not null);');

    this.addSql('create table "file_upload" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "file_upload_kind" text check ("file_upload_kind" in (\'ImageUpload\', \'DocumentUpload\', \'VideoUpload\', \'FileUpload\')) not null, "name" text not null, "size" int not null, "mime" text not null, "url" text not null, "last_modified_at" timestamptz(0) not null, "number_of_pages" smallint null, "number_of_words" int null, "document_type" text check ("document_type" in (\'Slideshow\', \'CSVLike\', \'Spreadsheet\', \'Code\', \'Markdown\', \'Text\', \'Document\')) null, "duration" int null, "width" smallint null, "height" smallint null);');
    this.addSql('create index "file_upload_file_upload_kind_index" on "file_upload" ("file_upload_kind");');

    this.addSql('create table "tag" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "tag_kind" text check ("tag_kind" in (\'TeamCategory\', \'Tag\')) not null, "name" text not null, "slug" text not null, "description" text null, "color" text check ("color" in (\'Blue\', \'DeepBlue\', \'DarkBlue\', \'LightBlue\', \'Green\', \'DeepGreen\', \'DarkGreen\', \'LightGreen\', \'Orange\', \'DeepOrange\', \'DarkOrange\', \'LightOrange\', \'Red\', \'DeepRed\', \'DarkRed\', \'LightRed\', \'Purple\', \'DeepPurple\', \'DarkPurple\', \'LightPurple\', \'Gray\', \'DeepGray\', \'DarkGray\', \'Turquoise\', \'Pink\', \'Cyan\', \'Brown\', \'Indigo\', \'Lime\', \'Teal\', \'Black\')) not null, "icon_image_id" bigint null);');
    this.addSql('create index "tag_tag_kind_index" on "tag" ("tag_kind");');

    this.addSql('create table "actor_image" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "actor_id" bigint not null, "image_id" bigint not null, "type" text check ("type" in (\'Avatar\', \'AvatarDarkMode\', \'Banner\', \'Profile\')) not null, "last_active_date" timestamptz(0) null);');
    ...
    this.addSql('create table "ugc" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "ugc_kind" text check ("ugc_kind" in (\'Content\', \'TenantDocument\', \'Form\', \'FormSubmission\')) not null, "description" text not null, "is_anonymous" boolean not null, "upvote_count" int not null, "downvote_count" int not null, "total_vote_count" int not null, "report_count" int not null, "favorite_count" int not null, "comment_count" int not null, "author_id" bigint null, "content_master_id" bigint null, "parent_id" bigint null, "document_kind" text check ("document_kind" in (\'InfoDocument\', \'StudyDocument\', \'Document\')) null, "new_version_id" bigint null, "year_version" smallint null, "name" text null, "schema" jsonb null, "type" text check ("type" in (\'EventJoin\', \'TeamJoin\', \'Internal\', \'Survey\')) null, "is_template" boolean null, "undeletable" boolean null, "submission" jsonb null, "linked_form_edit_id" bigint null);');
    ...
    this.addSql('create table "org" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "org_kind" text check ("org_kind" in (\'Canteen\', \'ClassGroup\', \'Cohort\', \'Team\', \'Tenant\')) not null, "actor_id" bigint not null, "parent_id" bigint null, "description" text null, "year" smallint null, "logo_id" bigint null, "tagline" text null, "type" text check ("type" in (\'Association\', \'Club\', \'Project\', \'Department\')) null default \'Project\', "video_id" bigint null, "membership_fees" int null, "current_finance" int null, "member_count" int null, "join_form_id" bigint null, "directors_category_name" text null, "managers_category_name" text null, "members_category_name" text null, "event_validation_form_id" bigint null);');
    ...
    this.addSql('create table "teach_class" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "user_id" bigint not null, "class_group_id" bigint not null, "start_date" timestamptz(0) not null, "end_date" timestamptz(0) null);');
    ...
    this.addSql('create table "project" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "name" text not null, "description" text null, "expected_budget" real not null, "actual_budget" real null, "is_private" boolean not null, "team_id" bigint not null);');
    ...
    this.addSql('create table "form_submission_edit" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "edit_kind" text check ("edit_kind" in (\'ContentEdit\', \'FormEdit\', \'FormSubmissionEdit\', \'DocumentEdit\')) not null default \'FormSubmissionEdit\', "added_diff" jsonb null, "linked_ugc_id" bigint not null, "new_version" jsonb not null);');

    this.addSql('create table "form_edit" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "edit_kind" text check ("edit_kind" in (\'ContentEdit\', \'FormEdit\', \'FormSubmissionEdit\', \'DocumentEdit\')) not null default \'FormEdit\', "added_diff" jsonb null, "linked_ugc_id" bigint not null, "new_version" jsonb not null, "edited_by_id" bigint null);');

    this.addSql('create table "edit" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "edit_kind" text check ("edit_kind" in (\'ContentEdit\', \'FormEdit\', \'FormSubmissionEdit\', \'DocumentEdit\')) not null, "added_diff" jsonb null, "linked_ugc_id" bigint not null);');

    this.addSql('create table "document_edit" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "edit_kind" text check ("edit_kind" in (\'ContentEdit\', \'FormEdit\', \'FormSubmissionEdit\', \'DocumentEdit\')) not null default \'DocumentEdit\', "added_diff" jsonb null, "linked_ugc_id" bigint not null, "new_version_id" bigint not null, "year_version" smallint null);');

    this.addSql('create table "content_master" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "content_master_kind" text check ("content_master_kind" in (\'TenantEvent\')) not null, "slug" text not null, "title" text not null, "root_content_id" bigint not null, "start" timestamptz(0) null, "end" timestamptz(0) null, "price" real null, "image_id" bigint null, "location_name" text null, "location_latitude" real null, "location_longitude" real null, "location_street" text null, "location_city" text null, "location_zip" int null, "location_state" text null, "location_country" text null, "state" text check ("state" in (\'Template\', \'Draft\', \'Submitted\', \'Rejected\', \'Approved\', \'Published\')) null default \'Draft\', "meta" jsonb null, "supervisor_id" bigint null, "private" boolean null, "auto_accept_joins" boolean null, "join_form_id" bigint null, "linked_project_id" bigint null, "regular_event_id" bigint null, "regular_event_interval" text null, "approval_submission_id" bigint null, "last_event_approval_step_id" bigint null);');
    ...
    this.addSql('create table "team_action" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "name" text not null, "description" text null, "state" text check ("state" in (\'Approved\', \'Canceled\', \'Pending\', \'Rejected\')) not null, "score" int not null, "team_id" bigint not null, "user_id" bigint not null, "team_member_id" bigint null, "linked_event_id" bigint null, "linked_project_id" bigint null, "validated_by_id" bigint null);');

    this.addSql('create table "role" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "role_kind" text check ("role_kind" in (\'TeamRole\', \'CanteenRole\', \'EventRole\', \'ProjectRole\')) not null, "name" text not null, "color" text check ("color" in (\'Blue\', \'DeepBlue\', \'DarkBlue\', \'LightBlue\', \'Green\', \'DeepGreen\', \'DarkGreen\', \'LightGreen\', \'Orange\', \'DeepOrange\', \'DarkOrange\', \'LightOrange\', \'Red\', \'DeepRed\', \'DarkRed\', \'LightRed\', \'Purple\', \'DeepPurple\', \'DarkPurple\', \'LightPurple\', \'Gray\', \'DeepGray\', \'DarkGray\', \'Turquoise\', \'Pink\', \'Cyan\', \'Brown\', \'Indigo\', \'Lime\', \'Teal\', \'Black\')) not null, "required" boolean not null, "canteen_id" bigint null, "linked_project_role_id" bigint null, "event_id" bigint null, "user_id" bigint null, "project_id" bigint null, "description" text null, "auto_accept" boolean null, "reward_minimum" smallint null, "reward_maximum" smallint null, "team_id" bigint null, "permissions" text[] null default \'{}\', "category" text check ("category" in (\'Directors\', \'Managers\', \'Members\')) null, "key" text check ("key" in (\'Director\', \'Treasurer\', \'Secretary\')) null);');
    ...
    this.addSql('create table "project_linked_events" ("project_id" bigint not null, "content_master_id" bigint not null, constraint "project_linked_events_pkey" primary key ("project_id", "content_master_id"));');

    this.addSql('create table "join" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "join_kind" text check ("join_kind" in (\'EventJoin\', \'TeamJoin\')) not null, "state" text check ("state" in (\'Approved\', \'Canceled\', \'Pending\', \'Rejected\')) not null default \'Pending\', "joiner_id" bigint not null, "settled_by_id" bigint null, "settled_at" timestamptz(0) null, "settled_message" text null, "form_submission_id" bigint not null, "linked_event_id" bigint null, "event_role_id" bigint null, "participated" boolean null, "team_action_id" bigint null, "presence_status" text check ("presence_status" in (\'Sure\', \'Maybe\', \'Absent\')) null, "team_id" bigint null, "asked_role_id" bigint null, "received_role_id" bigint null);');
    this.addSql('create index "join_join_kind_index" on "join" ("join_kind");');

    this.addSql('create table "interaction" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "interaction_kind" text check ("interaction_kind" in (\'Favorite\', \'Reaction\', \'Report\', \'Validation\', \'Vote\')) not null, "last_active_date" timestamptz(0) null, "linked_content_master_id" bigint null, "content_id" bigint not null, "actor_id" bigint not null, "reaction_type" text check ("reaction_type" in (\'What\', \'Interesting\', \'Like\', \'NotAnIssue\', \'Bump\', \'Laugh\', \'Unsure\', \'Partial\', \'Perfect\')) null, "target_id" bigint null, "reason" text null, "type" varchar(255) null, "value" smallint null);');
    ...
    this.addSql('create table "finance" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "transaction" text not null, "description" text null, "payment_date" timestamptz(0) not null, "payment_method" text check ("payment_method" in (\'Cash\', \'CreditCard\', \'Transfer\', \'RegularTransfer\', \'Check\', \'MobilePayment\', \'Other\')) not null, "address_name" text null, "address_latitude" real null, "address_longitude" real null, "address_street" text null, "address_city" text null, "address_zip" int null, "address_state" text null, "address_country" text null, "amount_due" real not null, "amount_payed" real not null, "state" text check ("state" in (\'Canceled\', \'Ongoing\', \'Completed\')) not null, "category" text check ("category" in (\'Entertainment\', \'Equipement\', \'Errands\', \'Fees\', \'MembershipFees\', \'Insurance\', \'Logistics\', \'Marketing\', \'Provider\', \'Subscriptions\', \'Transportation\', \'Other\')) not null, "team_id" bigint not null, "payed_by_id" bigint null, "linked_event_id" bigint null, "linked_project_id" bigint null);');
    ...
    this.addSql('create table "event_approval" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "event_id" bigint null, "message" text null, "approved" boolean not null, "step_id" bigint null);');
    ...
    this.addSql('create table "content_master_orgs" ("content_master_id" bigint not null, "org_id" bigint not null, constraint "content_master_orgs_pkey" primary key ("content_master_id", "org_id"));');
    ...
    this.addSql('create table "content_edit" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "tenant_id" bigint not null, "created_by_id" bigint null, "last_hidden_at" timestamptz(0) null, "edit_kind" text check ("edit_kind" in (\'ContentEdit\', \'FormEdit\', \'FormSubmissionEdit\', \'DocumentEdit\')) not null default \'ContentEdit\', "added_diff" jsonb null, "linked_ugc_id" bigint not null, "new_version" text not null, "note" text null);');
    ...
    this.addSql('create table "ugc_representing_orgs" ("ugc_id" bigint not null, "org_id" bigint not null, constraint "ugc_representing_orgs_pkey" primary key ("ugc_id", "org_id"));');
    ...
    this.addSql('alter table "org_metric" add constraint "org_metric_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "ugc" add constraint "ugc_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "org" add constraint "org_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "teach_class" add constraint "teach_class_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "org_document" add constraint "org_document_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "membership" add constraint "membership_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "project_supervisors" add constraint "project_supervisors_membership_id_foreign" foreign key ("membership_id") references "membership" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "event_approval_step" add constraint "event_approval_step_linked_tenant_id_foreign" foreign key ("linked_tenant_id") references "org" ("id") on update cascade;');
    ...
    this.addSql('alter table "form_submission_edit" add constraint "form_submission_edit_linked_ugc_id_foreign" foreign key ("linked_ugc_id") references "ugc" ("id") on update cascade on delete CASCADE;');
    ...
    this.addSql('alter table "form_edit" add constraint "form_edit_linked_ugc_id_foreign" foreign key ("linked_ugc_id") references "ugc" ("id") on update cascade on delete CASCADE;');
    ...
    this.addSql('alter table "edit" add constraint "edit_tenant_id_foreign" foreign key ("tenant_id") references "tenant_core" ("id") on update cascade;');
    this.addSql('alter table "edit" add constraint "edit_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    this.addSql('alter table "edit" add constraint "edit_linked_ugc_id_foreign" foreign key ("linked_ugc_id") references "ugc" ("id") on update cascade on delete CASCADE;');
    ...
    this.addSql('alter table "document_edit" add constraint "document_edit_linked_ugc_id_foreign" foreign key ("linked_ugc_id") references "ugc" ("id") on update cascade on delete CASCADE;');
    ...
    this.addSql('alter table "content_master" add constraint "content_master_linked_project_id_foreign" foreign key ("linked_project_id") references "project" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "team_action" add constraint "team_action_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "role" add constraint "role_linked_project_role_id_foreign" foreign key ("linked_project_role_id") references "role" ("id") on update cascade on delete set null;');
    this.addSql('alter table "role" add constraint "role_event_id_foreign" foreign key ("event_id") references "content_master" ("id") on update cascade on delete set null;');
    this.addSql('alter table "role" add constraint "role_user_id_foreign" foreign key ("user_id") references "individual" ("id") on update cascade on delete set null;');
    this.addSql('alter table "role" add constraint "role_project_id_foreign" foreign key ("project_id") references "project" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "project_linked_events" add constraint "project_linked_events_project_id_foreign" foreign key ("project_id") references "project" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "project_linked_events" add constraint "project_linked_events_content_master_id_foreign" foreign key ("content_master_id") references "content_master" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "join" add constraint "join_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "join" add constraint "join_linked_event_id_foreign" foreign key ("linked_event_id") references "content_master" ("id") on update cascade on delete set null;');
    this.addSql('alter table "join" add constraint "join_event_role_id_foreign" foreign key ("event_role_id") references "role" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "interaction" add constraint "interaction_created_by_id_foreign" foreign key ("created_by_id") references "individual" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "content_master_orgs" add constraint "content_master_orgs_content_master_id_foreign" foreign key ("content_master_id") references "content_master" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "content_master_orgs" add constraint "content_master_orgs_org_id_foreign" foreign key ("org_id") references "org" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "content_edit" add constraint "content_edit_linked_ugc_id_foreign" foreign key ("linked_ugc_id") references "ugc" ("id") on update cascade on delete CASCADE;');
    ...
    this.addSql('alter table "ugc_representing_orgs" add constraint "ugc_representing_orgs_ugc_id_foreign" foreign key ("ugc_id") references "ugc" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "ugc_representing_orgs" add constraint "ugc_representing_orgs_org_id_foreign" foreign key ("org_id") references "org" ("id") on update cascade on delete cascade;');
  }
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "edit" drop constraint "edit_tenant_id_foreign";');
    ...
    this.addSql('alter table "org_metric" drop constraint "org_metric_created_by_id_foreign";');
    ...
    this.addSql('alter table "ugc" drop constraint "ugc_created_by_id_foreign";');

    this.addSql('alter table "ugc" drop constraint "ugc_author_id_foreign";');

    this.addSql('alter table "org" drop constraint "org_created_by_id_foreign";');

    this.addSql('alter table "teach_class" drop constraint "teach_class_created_by_id_foreign";');
    ...
    this.addSql('alter table "org_document" drop constraint "org_document_created_by_id_foreign";');

    this.addSql('alter table "membership" drop constraint "membership_created_by_id_foreign";');
    ...
    this.addSql('alter table "edit" drop constraint "edit_created_by_id_foreign";');
    ...
    this.addSql('alter table "role" drop constraint "role_user_id_foreign";');

    this.addSql('alter table "join" drop constraint "join_created_by_id_foreign";');
    ...
    this.addSql('alter table "interaction" drop constraint "interaction_created_by_id_foreign";');
    ...
    this.addSql('alter table "ugc" drop constraint "ugc_new_version_id_foreign";');
    ...
    this.addSql('alter table "form_submission_edit" drop constraint "form_submission_edit_linked_ugc_id_foreign";');

    this.addSql('alter table "form_edit" drop constraint "form_edit_linked_ugc_id_foreign";');

    this.addSql('alter table "edit" drop constraint "edit_linked_ugc_id_foreign";');

    this.addSql('alter table "document_edit" drop constraint "document_edit_linked_ugc_id_foreign";');
    ...
    this.addSql('alter table "content_edit" drop constraint "content_edit_linked_ugc_id_foreign";');

    this.addSql('alter table "ugc_attachments" drop constraint "ugc_attachments_ugc_id_foreign";');

    this.addSql('alter table "ugc_representing_orgs" drop constraint "ugc_representing_orgs_ugc_id_foreign";');
    ...
    this.addSql('alter table "event_approval_step" drop constraint "event_approval_step_linked_tenant_id_foreign";');
    ...
    this.addSql('alter table "content_master_orgs" drop constraint "content_master_orgs_org_id_foreign";');

    this.addSql('alter table "ugc_representing_orgs" drop constraint "ugc_representing_orgs_org_id_foreign";');
    ...
    this.addSql('alter table "content_master" drop constraint "content_master_linked_project_id_foreign";');

    this.addSql('alter table "team_action" drop constraint "team_action_linked_project_id_foreign";');

    this.addSql('alter table "role" drop constraint "role_project_id_foreign";');

    this.addSql('alter table "project_linked_events" drop constraint "project_linked_events_project_id_foreign";');

    this.addSql('alter table "finance" drop constraint "finance_linked_project_id_foreign";');

    this.addSql('alter table "project_supervisors" drop constraint "project_supervisors_membership_id_foreign";');
    ...
    this.addSql('alter table "role" drop constraint "role_event_id_foreign";');

    this.addSql('alter table "project_linked_events" drop constraint "project_linked_events_content_master_id_foreign";');

    this.addSql('alter table "join" drop constraint "join_linked_event_id_foreign";');
    ...
    this.addSql('alter table "content_master_orgs" drop constraint "content_master_orgs_content_master_id_foreign";');
    ...
    this.addSql('alter table "role" drop constraint "role_linked_project_role_id_foreign";');
    ...
    this.addSql('alter table "join" drop constraint "join_event_role_id_foreign";');
    ...
    this.addSql('drop table if exists "project_linked_events" cascade;');
    ...
    this.addSql('drop table if exists "content_master_orgs" cascade;');
    ...
    this.addSql('drop table if exists "ugc_representing_orgs" cascade;');
  }
