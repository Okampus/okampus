...
export class Migration20220728234830 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "school_group" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "english_name" text null, "parent_id" varchar(255) null, "description" text null, "active" boolean not null);');
    this.addSql('create index "school_group_parent_id_index" on "school_group" ("parent_id");');
    this.addSql('alter table "school_group" add constraint "school_group_pkey" primary key ("id");');
    ...
    this.addSql('create table "info_doc" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "file_id" varchar(255) not null, "doc_series_id" varchar(255) null, "year" int not null, "school_group_id" varchar(255) null, "description" text null, "is_obsolete" boolean not null);');
