...
export class Migration20220721155752 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "daily_menu_starters" ("daily_menu_id" int not null, "food_id" int not null);');
    this.addSql('alter table "daily_menu_starters" add constraint "daily_menu_starters_pkey" primary key ("daily_menu_id", "food_id");');

    this.addSql('create table "daily_menu_dishes" ("daily_menu_id" int not null, "food_id" int not null);');
    ...
    this.addSql('create table "user" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "firstname" text not null, "lastname" text not null, "password" text null, "email" text not null, "reputation" int not null, "avatar" text null, "roles" text[] not null default \'{user}\', "school_role" text check ("school_role" in (\'student\', \'teacher\', \'admin\')) not null, "color" text null, "signature" text null, "banner" text null, "short_description" text null, "points" int not null);');
    ...
    this.addSql('create table "content_master" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "title" text not null, "post_id" int not null, "kind" text check ("kind" in (\'blog\', \'thread\')) not null, "slug" text null, "category" text null, "location_name" text null, "location" text null, "is_draft" boolean null, "type" smallint null, "locked" boolean null, "op_validation_id" int null);');
    ...
    this.addSql('create table "validation" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "content_master_id" int null, "user_id" varchar(255) not null, "content_id" int not null, "active" boolean not null default true, "type" varchar(255) not null);');
    ...
    this.addSql('create table "profile_image" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "file_id" varchar(255) not null, "user_id" varchar(255) null, "team_id" int null);');
    ...
    this.addSql('create table "content_master_participants" ("content_master_id" int not null, "user_id" varchar(255) not null);');
