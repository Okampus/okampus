<template lang="">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 p-4 gap-4">
        <div
            ...
            :key="i"
            class="shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 text-white font-medium group md:flex-col"
            :class="card.class"
        >
            <div class="text-center flex md:flex-col space-x-4 md:space-x-0">
                <div class="text-xl">
                    {{ card.quantity }}
                </div>
                <div class="font-bold">
            ...
            <div class="flex items-center justify-between">
                <a
                    :href="card.link"
                    class="px-2 font-bold text-5 bg-2 rounded hover:bg-white"
                >View all</a>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="flex-grow flex justify-between items-center">
                                        <div class="self-center">
                                            <a
                                                ...
                                                href="#0"
                                                style="outline: none;"
                                            >240+</a> users have subscribed to <a
                                                class="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100"
                                                href="#0"
                                                style="outline: none;"
                                            >Newsletter #1</a>
    ...
    data () {
        return {
            ...
            statistics: [
                ...
                { title: 'Nouveaux articles', quantity: 557 },
                { title: 'Partages', quantity: 11257 },
                { title: 'Vues', quantity: 7525 }
            ]
        }
    }
}
